...
// 环境变量
const UUID = process.env.UUID || 'fa812eda-0ecc-45c3-9533-708bee4c9570'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const SUB_PATH = process.env.SUB_PATH || 'mansel197';            // 节点订阅路径
const DOMAIN = process.env.DOMAIN || 'hugg293-bb.hf.space';                   // 域名或ip,留空将自动获取服务器ip
